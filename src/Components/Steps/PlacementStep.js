...
function PlacementStep({
  ...
  */
  const handleConfirmPlacementClick = async (e) => {
    ...
    pushToDb(dataUrl, currentMessage.getAttribute("data-x"), currentMessage.getAttribute("data-y"), currentMessage.getAttribute("width"), currentMessage.getAttribute("height"), currentContinent);
  ...
  return (
    <>
      ...
      >{`Place your message on the continent.`}</a>
      <button
        className="confirmContinentButton"
